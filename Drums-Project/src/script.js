...
const activeStyle = {
  backgroundColor: "#7fff87",
  boxShadow: "0 3px #7fff87",
  height: 77,
  marginTop: 13 };
...
class DrumPad extends React.Component {
  ...
  activatePad() {
    if (this.props.power) {
      if (this.state.padStyle.backgroundColor === "#7fff87") {
        this.setState({
          padStyle: inactiveStyle });
...
class App extends React.Component {
  ...
  render() {
    ...
    return (
      ...
      React.createElement("div", { className: "inner-logo " }, "Drums Project" + String.fromCharCode(160)), 
